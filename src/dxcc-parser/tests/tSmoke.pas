...
begin
  ...
  { Mark count for CqrlogImproved's bundled ctyfiles; the refreshed upstream
    cqrlog data yields 21560.  Re-sync when ctyfiles are updated. }
  AssertEquals('mark count of country-plain.tab', 20378, T.Count);
end;
