...
begin
  ...
  cqrini.WriteBool('Program', 'CheckImproved', chkNewImproved.Checked);
...
begin
  ...
  chkNewImproved.Checked := cqrini.ReadBool('Program', 'CheckImproved', True);
