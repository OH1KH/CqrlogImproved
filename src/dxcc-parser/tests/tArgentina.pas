...
begin
  ...
  { Upstream uses LU8DBS/Z here, but this repo's older CallResolution.tbl
    lists it only with a 2017-2018 window, which the 2020/01/01 lookup date
    misses.  LU4AA/Z is stored verbatim with no window in both data sets. }
  AssertPattern('LU4AA/Z', '=LU4AA/Z');
  AssertCountryContains('LU4AA/Z', 'Carlini');
end;
